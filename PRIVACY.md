...
For the purposes of this Privacy Policy:
  ...
  * Application refers to TicketSaver, the software program provided by the
    Company.

  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Agreement) refers to TicketSaver.
...
You have the right to request the deletion of the personal data we have collected from you. You can delete certain information yourself within the Service if the option is available.

If you wish to have your personal data deleted and you cannot do this yourself, please contact us at **maxbrouwermd@gmail.com** with your request. We will process your request as soon as possible, in accordance with applicable laws.

Please note that in some cases we may need to retain certain information to comply with legal obligations or resolve disputes.
